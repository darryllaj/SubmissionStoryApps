...
class StoryRemoteMediator (
    ...
    override suspend fun load(
        ...
        val page = when (loadType){
            ...
            LoadType.APPEND -> {
//                val lastItemIndex = state.anchorPosition ?: return MediatorResult.Success(endOfPaginationReached = true)
//                lastItemIndex / state.config.pageSize + 1
    ...
    private suspend fun getRemoteKeysForFirstItem(state: PagingState<Int, ListStoryItem>): StoryRemoteKeys?{
